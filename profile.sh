...
account_id=$(( RANDOM % 10 ))
        ...
        acct_ID_Exists=$(psql -d atahernia -U atahernia -AXqtc "SELECT EXISTS(SELECT account_id FROM envy_account_info WHERE account_id = '$account_id')")
...
isInSystem=$(psql -d atahernia -U atahernia -AXqtc "SELECT EXISTS(SELECT account_id FROM envy_account_info WHERE username = '$username')")
...
account_id=$(psql -d atahernia -AXqtc "SELECT account_id FROM envy_account_info WHERE username = '$username'")
financial_score=$(psql -d atahernia -AXqtc "SELECT financial_score FROM envy_account_info WHERE username = '$username'")
name=$(psql -d atahernia -AXqtc "SELECT name FROM envy_account_info WHERE username = '$username'")
address=$(psql -d atahernia -AXqtc "SELECT address FROM envy_account_info WHERE username = '$username'")
occupation=$(psql -d atahernia -AXqtc "SELECT occupation FROM envy_account_info WHERE username = '$username'")
education=$(psql -d atahernia -AXqtc "SELECT education FROM envy_account_info WHERE username = '$username'")
relationship=$(psql -d atahernia -AXqtc "SELECT relationship FROM envy_account_info WHERE username = '$username'")
goals=$(psql -d atahernia -AXqtc "SELECT goals FROM envy_account_info WHERE username = '$username'")
bio=$(psql -d atahernia -AXqtc "SELECT bio FROM envy_account_info WHERE username = '$username'")
...
IFS="#"
contentArry=($(psql -d atahernia -AXqt --command "SELECT content FROM envy_content WHERE account_id = '$account_id'"))

IFS="@"
dateArry=($(psql -d atahernia -AXqt --command "SELECT date FROM envy_content WHERE account_id = '$account_id'"))
